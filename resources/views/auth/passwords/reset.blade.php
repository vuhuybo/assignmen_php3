                ...
                <div class="p-2">
                    <form method="POST" action="{{ route('password.update') }}" >
                        ...
                        <div class="mb-3">
                            ...
                            <input id="password" type="password" placeholder="Confirm Password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                        ...
                        <div class="mt-4">
                            <button class="btn w-100" type="submit" style="background-color:rgb(82, 128, 82);color:white;">Reset Password</button>
                        </div>
